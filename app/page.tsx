...
export default function HomePage() {
  return (
    ...
    >
      <header className="mb-6 max-w-3xl md:mb-8 lg:mb-10">
        <h1 className="ui-page-title max-w-[10.5ch] text-[2.45rem] font-semibold leading-[0.96] tracking-[-0.06em] sm:text-4xl md:max-w-[11.5ch] md:text-[3.15rem] lg:text-[3.9rem]">
          输入学习目标，
          <br />
          直接开始课程。
        </h1>

        <p className="ui-page-description mt-4 max-w-2xl text-[15px] leading-7 md:text-[1.05rem] md:leading-8">
