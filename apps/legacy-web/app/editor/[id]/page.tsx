...
import { Book, ChevronLeft, Edit3, Layout, Menu, Sparkles, Split, X } from "lucide-react";
...
export default function EditorPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const _leftSidebarWidth = 280;
  const _rightSidebarWidth = 360;

  const _leftSidebarLeft = useTransform(leftSidebarX, (x) => x);
  const _rightSidebarRight = useTransform(rightSidebarX, (x) => -x);
