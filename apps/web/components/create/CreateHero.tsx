        ...
        <div className="w-full max-w-4xl mx-auto px-6 py-12 md:py-24">
            ...
            >
                ...
                <div className="flex flex-wrap justify-center gap-3 opacity-40">
                    <InspirationTag icon={Lightbulb} label="Modern Architecture" onClick={() => setInput("Modern Architecture")} />
                    <InspirationTag icon={Target} label="Rust Systems" onClick={() => setInput("Rust Systems")} />
                    <InspirationTag icon={Rocket} label="Space Exploration" onClick={() => setInput("Space Exploration")} />
                </div>
            </motion.div>
        </div>
    )
