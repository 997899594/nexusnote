...
import { Check, Loader2, X, Sparkles, Layout, Cpu } from 'lucide-react'
                ...
                <AnimatePresence mode="popLayout">
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <div className={`text-sm font-bold tracking-tight flex-1 ${
                                step.status === 'completed' ? 'text-black/30' :
                                step.status === 'error' ? 'text-red-600' :
                                step.status === 'processing' ? 'text-black' :
                                'text-black/10'
                            }`}>
                                {step.text}
                            </div>
