...
import { BookOpen, FileText, Home, Layers, Plus, Settings, Zap } from "lucide-react";
  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-0 h-full w-[240px] bg-zinc-50 border-r border-black/[0.06] flex-col z-50">
      ...
      <nav className="flex-1 px-3 py-6 space-y-1">
        <div className="px-3 mb-2 text-[10px] font-bold text-black/30 uppercase tracking-widest">
          Platform
        </div>
        {navItems.map((item) => {
        ...
        <div className="px-3 mt-8 mb-2 text-[10px] font-bold text-black/30 uppercase tracking-widest">
          Library
        </div>
