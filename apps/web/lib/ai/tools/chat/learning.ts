...
export const summarize = tool({
  ...
  inputSchema: z.object({
    ...
    style: z
      ...
      .describe("摘要风格"),
    preserveStructure: z.boolean().default(false).describe("是否保留原文结构（章节标题等）"),
    language: z.enum(["zh", "en", "auto"]).default("auto").describe("摘要语言"),
  }),
...
// 导出流式生成函数供前端使用
export { streamQuizQuestions, streamMindMapNodes };
