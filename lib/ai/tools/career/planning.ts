  ...
  return {
    presentCareerGraphPatch: tool({
      description: [
        ...
        "每次调用都必须优先填写 mentorBrief：先给职业规划导师的判断，再给 2-4 个现实职业方向和 2-5 个技能优先级，最后只问一个开放式温和校准问题。",
        ...
        "禁止把课程章节技术点包装成考试题；nextQuestion 必须像真实职业规划导师或心理辅导老师一样自然，目的是校准职业动机、长期取舍、工作方式、约束或风险承受。",
